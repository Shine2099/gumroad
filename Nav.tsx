      ...
      footer={
        <>
          ...
          <DashboardNavProfilePopover user={currentSeller}>
            <div role="menu" className="border-0! shadow-none! dark:border! max-h-[70vh] overflow-y-auto">
    ...
    >
      <NavSection>
        ...
        {loggedInUser?.policies.community.index ? (
          <NavLink text="Community" icon="solid-chat-alt" href={Routes.communities_path()} />
        ) : null}
      </NavSection>
      <NavSection>
