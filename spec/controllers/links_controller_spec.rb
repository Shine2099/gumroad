    ...
    describe "POST create" do
      ...
      describe "form submission behavior" do
        context "on success" do
          it "redirects to edit page without flash error" do
            params = { price_cents: 100, name: "test link" }
            post :create, params: { link: params }
          ...
          it "creates a new product" do
            ...
            expect {
              post :create, params: { link: params }
            }.to change { seller.links.count }.by(1)
          end
        end

        context "on failure" do
          it "sets flash error message when name is missing" do
            params = { price_cents: 100 }
            post :create, params: { link: params }
          ...
          it "sets flash error message when price is missing" do
            params = { name: "test link" }
            post :create, params: { link: params }
          ...
          it "does not create a product when validation fails" do
            params = { price_cents: 100 }
            expect {
              post :create, params: { link: params }
            }.not_to change { seller.links.count }
          end

          it "sets flash error with custom message on general failure" do
