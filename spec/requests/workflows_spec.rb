  ...
  describe "saving emails" do
    ...
    context "when seller name is invalid for email delivery" do
      it "displays warning and prompts user to update the name" do
        ...
        expect(page).to have_alert(text: "Your name contains a colon (:) which causes email delivery problems and will be removed from the sender name when emails are sent.")
