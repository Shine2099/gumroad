...
describe "Audience analytics", :js, :sidekiq_inline, :elasticsearch_wait_for_refresh, type: :system do
  ...
  context "with followers" do
    ...
    it "shows the chart" do
      ...
      chart.hover
      expect(page).to have_tooltip(text: "1 new follower1 follower removed2 total followers", visible: :all)
      ...
      chart.hover
      expect(page).to have_tooltip(text: "0 new followers2 total followersSunday, December 17", visible: :all)
    end
  end
end
