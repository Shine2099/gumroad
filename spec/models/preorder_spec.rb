    ...
    it "returns proper json for a preorder with a url redirect post charge" do
      travel_to(Time.current) do
        ...
        link.product_files << create(
          :product_file, url: "#{AWS_S3_ENDPOINT}/gumroad-specs/attachments/6996320f4de6424990904fcda5808cef/original/Don&amp;#39;t Stop.mp3"
        )
        link.product_files << create(
          :product_file, url: "#{AWS_S3_ENDPOINT}/gumroad-specs/attachments/a1a5b8c8c38749e2b3cb27099a817517/original/Alice&#39;s Adventures in Wonderland.pdf"
        )
