...
class Exports::PurchaseExportService
  PURCHASE_FIELDS = [
    ...
    "Affiliate", "Affiliate commission ($)", "Discover?", "Subscription End Date", "Cancellation Date", "Rating", "Review",
  ...
  private
    def purchase_data(purchase)
      ...
      data = {
        ...
        "Cancellation Date" => purchase.subscription&.cancelled_at&.to_s,
