        ...
        <div className="flex flex-col gap-4">
          ...
          {communities ? (
            communities.status === "fetching" ? (
              ...
              <Alert color="danger">Could not retrieve communities from Circle. Please check your API key.</Alert>
            ) : (
              <fieldset>
                <legend>
          ...
          {spaceGroups ? (
            spaceGroups.status === "fetching" ? (
              ...
              <Alert color="danger">Could not retrieve space groups from Circle. Please try again.</Alert>
            ) : (
              <>
                <fieldset>
                  <legend>
