 (function () {
   var enabledMeta = document.querySelector('meta[property="gr:tiktok_pixel:enabled"]');
   if (!enabledMeta || enabledMeta.getAttribute("content") !== "true") return;

   var idMeta = document.querySelector('meta[property="gr:tiktok_pixel:id"]');
   if (!idMeta) return;

   var pixelId = idMeta.getAttribute("content");
   if (!pixelId) return;
