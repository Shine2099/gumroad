...
class UsersController < ApplicationController
  ...
  def coffee
    ...
    product_props = ProductPresenter.new(pundit_user:, product:, request:).product_props(seller_custom_domain_url:, recommended_by: params[:recommended_by])
    creator_profile = ProfilePresenter.new(pundit_user:, seller: product.user).creator_profile

    render inertia: "Users/Coffee", props: product_props.merge(
      creator_profile:,
